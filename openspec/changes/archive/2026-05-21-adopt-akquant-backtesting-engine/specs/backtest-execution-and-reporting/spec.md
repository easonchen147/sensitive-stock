...
The system SHALL accept an AKQuant-first structured backtest request grouped by market scope, strategy selection, execution settings, transaction costs, and risk controls, while still mapping supported legacy request fields during the migration period.
