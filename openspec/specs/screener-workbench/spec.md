# screener-workbench Specification

## Purpose
Define the stock screening workbench contract, including structured filters, natural-language filter interpretation, reusable result export, and backtest handoff.
